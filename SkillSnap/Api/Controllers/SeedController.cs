...
namespace Api.Controllers
{
    ...
    public class SeedController : ControllerBase
    {
        ...
        public SeedController(SkillSnapContext context, UserManager<ApplicationUser> User, RoleManager<IdentityRole> roleManager)
        {
            _context = context;
            _userManager = User;
        ...
        [HttpPost("data")]
        public IActionResult SeedProjects()
        {
        ...
        {
            var user = new ApplicationUser { UserName = "admin@email.com", Email = "admin@email.com", FirstInitial = "A", LastName = "Admin" };
